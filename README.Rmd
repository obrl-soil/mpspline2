...
[![Coverage status](https://codecov.io/github/obrl-soil/mpspline2/branch/master/graph/badge.svg)](https://app.codecov.io/github/obrl-soil/mpspline2?branch=master)
...
If you get stuck using this package, please post a question on [Stack Overflow](https://stackoverflow.com/). This means that others can benefit from the discussion, and more people are available to help you. You're welcome to ping me on Bluesky (@obrlsoil) or Mastodon (@obrl_soil) to get my attention.
